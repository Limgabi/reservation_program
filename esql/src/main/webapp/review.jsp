...
<body>
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
						...
						<th style="background-color: #eeeeee; text-align: center;">작성자ID</th>
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="view.jsp?reviewNum=<%= list.get(i).getReviewNum()%>"><%= list.get(i).getReviewTitle() %></a></td>
						<td><%= list.get(i).getUserID() %></td>
						<td><%= list.get(i).getReviewDate().substring(0, 11) + list.get(i).getReviewDate().substring(11, 13) + "시 " + list.get(i).getReviewDate().substring(14, 16) + "분" %></td>
					</tr>
					<%		
						}
					%>
			...
			%>
			<a href="write.jsp" class="btn btn-primary pull-right">리뷰 작성</a>
		</div>
	</div>
